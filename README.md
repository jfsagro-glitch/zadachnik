...
Проект автоматически развертывается на GitHub Pages при каждом push в main ветку.

**Живая версия**: https://jfsagro-glitch.github.io/zadachnik/

### 2. Ручная настройка GitHub Pages

1. Перейдите в **Settings** репозитория
2. Найдите раздел **Pages** в боковом меню
3. В разделе **Source** выберите **GitHub Actions**
4. Система автоматически развернет проект

### 3. Тестирование

1. Откройте https://jfsagro-glitch.github.io/zadachnik/
2. Нажмите **"Демо-режим"**
3. Система создаст демо-сессию с тестовыми данными (используя LocalStorage)
...
### Версии проекта
- **Статистическая версия** (GitHub Pages): использует LocalStorage для данных
- **Серверная версия** (локальная): Node.js + Express + SQLite

### Ограничения GitHub Pages
- **Статические файлы**: только HTML, CSS, JS
- **Нет серверной логики**: все данные хранятся в LocalStorage
...
**🌐 URL**: `https://cursor-pipeline-demo.glitch.me` (после развертывания)
