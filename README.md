...
4. Вставьте URL этого репозитория: `https://github.com/jfsagro-glitch/zadachnik`
5. Нажмите **"Import"**
...
1. Откройте предоставленный Glitch URL (например: `https://cursor-pipeline-demo.glitch.me`)
