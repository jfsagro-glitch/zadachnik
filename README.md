...
### ⭐ Рекомендуемый способ: GitHub Codespaces (Полный функционал)

1. **Откройте в Codespaces**: Нажмите зеленую кнопку "Code" → "Codespaces" → "Create codespace on main"
2. **Автоматический запуск**: Codespaces автоматически установит зависимости и запустит сервер
3. **Доступ**: Приложение откроется в браузере по адресу `https://[codespace-name]-3000.app.github.dev`
4. **Полный функционал**: Kanban доска, API, база данных, демо-сессии

📖 **Подробная инструкция**: [CODESPACES.md](./CODESPACES.md)

### Вариант 2: GitHub Pages (Статическая демо-версия)
...
### Вариант 3: Локальный запуск (Полный функционал)
...
### Вариант 4: Развертывание на сервере
